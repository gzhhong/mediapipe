...
def create_metadata():
    ...
    metadata_model.description = "Identify the predefined landmarks on a potentially present hand and provide information about their positions within the given image or a video stream."
